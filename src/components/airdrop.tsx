...
export const Airdrop = () => {
    ...
    const sendAirdrop = async () => {
        ...
        const fromAirDropStatus = await connection.confirmTransaction(fromAirDropSignature)
        console.log(fromAirDropStatus)
    }

    return (
        <div>
            <input value={amount} onChange={(e) => setAmount(Number(e.target.value))} type="text" placeholder="Enter wallet address" />
